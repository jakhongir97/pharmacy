      ...
      <div class="main_container">
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-briefcase"></i> My Pharmacy <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="#">Change the price</a></li>
          ...
          <div class="">
            <div class="page-title">
              <div  class="title_left">
                  <h3 ><center style="color:red">NOT ACTIVATED!!! </center>   <br>You will be activated by Administrator by soon</h3>
                  <br>
              </div>
        ...
        <footer>
          <div class="pull-right">
            Pharmacy.uz <a href="https://pharmacy.uz"></a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
