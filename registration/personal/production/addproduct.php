...
<html lang="en">
  ...
  <body class="nav-md">
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Here you can add new drugs to your store</h2>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
                      ...
                      <thead>
                        <tr>
                        <th>Name</th>
                        <th>Check to add the product</th>
                        </tr>
                      </thead>
    ...
    $var="SELECT p.id, p.product FROM product p  WHERE p.id NOT IN (SELECT p.id FROM product p INNER JOIN link l ON l.idDrug=p.id INNER JOIN pharmacy s ON s.UserId=l.idPharmacy WHERE s.UserId='$pro')";
            $result=mysqli_query($conn, $var);
                           $k=1;
            ...
            ?>
                    ...
                    ?>  
                          ...
                          <button class="btn btn-success" id="btn" style=" width:90px;" onclick="add.php"> Add </button>
                          </form>
                  </div>
            </div>
</div>
