...
<html lang="en">
  ...
  <body class="nav-md">
    ...
    <div class="container body" style="height:95%">
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Here you can change the price of your drugs</h2>
    ...
    $var="SELECT p.id, p.product FROM product p INNER JOIN link l ON l.idDrug=p.id INNER JOIN pharmacy s ON s.UserId=l.idPharmacy WHERE s.UserId='$pro'";
            $result=mysqli_query($conn, $var);
                    ...
                    {
                            $idproduct=$row["id"];
                            $sql="SELECT l.price FROM link l WHERE l.idPharmacy='$pro' AND idDrug='$idproduct'";
                            $prise=mysqli_query($conn, $sql);
                            $priserow=mysqli_fetch_array($prise);
                           
            ?>
                        <tr>
                          <td><?= $row["product"] ?></td>
                          
                          <td><input type="text" name="text<?= $k ?>" value="<?= $priserow["price"] ?>" size="10"></td>
                           <td>
                    ...
                    ?>  
                          ...
                          <button class="btn btn-primary" id="btn" style=" width:90px;" onclick="changeprice.php">Refresh</button>
                          </form>
                  </div>
            </div>
</div>
