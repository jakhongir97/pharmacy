...
<html lang="en">
  ...
  <body class="nav-md">
    ...
    $var="SELECT p.id, p.product, p.price FROM product p ";
            $result=mysqli_query($conn, $var);
                   ...
                   ?>
                        <tr>
                          ...
                          <td><input type="text" name="text<?= $k ?>" value="<?= $row["price"] ?>" size="10"></td>
                           <td>
                    ...
                    ?>  
                          ...
                          <button id="btn" style=" width:90px;" onclick="changeprice.php">Refresh</button>
                          </form>
                  </div>
            </div>
</div>
