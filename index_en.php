...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
					...
					<div class="col-md-4">
						...
						<div class="header-left clearfix">
							...
							<div class="site-name-and-slogan smooth-scroll">
								...
								<div class="site-slogan"><a target="_blank" href="http://htmlcoder.me">Pharmacy.uz</a> Search Drugs Easy</div>
							</div>
									...
									<div class="container-fluid">
										...
										<div class="collapse navbar-collapse scrollspy smooth-scroll" id="navbar-collapse-1">
											<ul class="nav navbar-nav navbar-right">
                                                ...
                                                <li><a style="padding-right:0px;text-decoration:underline; font-size: 10px;" href="index_ru.php">RUS</a></li>
                                                <li><a style="padding-right:0px; font-size: 10px; text-decoration:underline;" href="index_uz.php">UZB</a></li> 
											</ul>
										</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 object-non-visible" data-animation-effect="fadeIn">
							<h1 class="text-center">We are <span>Pharmacy</span></h1>
  ...
  <div style="width:680px; height:200px; overflow:auto;"> 
  <table id="keywords" cellspacing="0" cellpadding="1">
    <thead>
      <tr>
    ...
    if(isset($_REQUEST['product'])) {
		...
		<div class="section clearfix object-non-visible" data-animation-effect="fadeIn">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h1 id="about" class="title text-center">About <span>Pharmacy.uz</span></h1>
                        <br>
				            <div class="space"></div>
		...
		<footer id="footer">
			...
			<div class="footer section">
				<div class="container">
					<h1 class="title text-center" id="contact"><span>CONTUCT US</span></h1>
					<div class="space"></div>
					<div class="row">
						<div class="col-sm-6">
